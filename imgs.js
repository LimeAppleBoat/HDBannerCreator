...
<polygon points="0, 0 0, 200 100, 200 100, 0" stroke-width="4" fill="?" />
</svg>`;

svg_map["diagonal_up_left"] = `<svg width="100" height="200">
<polygon points="0, 0 0, 200 100, 200" stroke-width="4" fill="?" />
</svg>`;

svg_map["diagonal_up_right"] = `<svg width="100" height="200">
<polygon points="100, 0 0, 0 0, 200" stroke-width="4" fill="?" />
</svg>`;

svg_map["triangle_top"] = `<svg width="100" height="200">
<polygon points="0 0, 50 100, 100 0" stroke-width="4" fill="?" />
</svg>`;

svg_map["triangle_bottom"] = `<svg width="100" height="200">
<polygon points="0 200, 50 100, 100 200" stroke-width="4" fill="?" />
</svg>`;

svg_map["rhombus"] = `<svg width="100" height="200">
<polygon points="50, 40 85, 100 50, 160 15, 100" stroke-width="4" fill="?" />
</svg>`;

svg_map["stripe_left"] = `<svg width="100" height="200">
<polygon points="0, 0 0, 200 33, 200 33, 0" stroke-width="4" fill="?" />
</svg>`;

svg_map["stripe_center"] = `<svg width="100" height="200">
<polygon points="33, 0 33, 200 67, 200 67, 0" stroke-width="4" fill="?" />
</svg>`;

svg_map["stripe_right"] = `<svg width="100" height="200">
<polygon points="67, 0 67, 200 100, 200 100, 0" stroke-width="4" fill="?" />
</svg>`;

svg_map["triangles_bottom"] = `<svg width="100" height="200">
<polygon points="0, 200 16.5, 165 33, 200 50, 165 67, 200 83.5, 165 100, 200" stroke-width="4" fill="?" />
</svg>`;

svg_map["triangles_top"] = `<svg width="100" height="200">
<polygon points="0, 0 16.5, 35 33, 0 50, 35 67, 0 83.5, 35 100, 0" stroke-width="4" fill="?" />
</svg>`;

svg_map["creeper"] = `<svg width="100" height="200">
<polygon points="5,70 35,70 35,100 5,100" stroke-width="4" fill="?" />
<polygon points="95,70 65,70 65,100 95,100" stroke-width="4" fill="?" />
<polygon points="35,100 35,115 20,115 20,160 35,160 35,145 65,145 65,160 80,160 80,115 65,115 65,100" stroke-width="4" fill="?"></polygon>
</svg>`;

svg_map["half_vertical"] = `<svg width="100" height="200">
<polygon points="0,0 50,0 50,200 0,200" stroke-width="4" fill="?" />
</svg>`;

svg_map["half_vertical_right"] = `<svg width="100" height="200">
<polygon points="50,0 100,0 100,200 50,200" stroke-width="4" fill="?" />
</svg>`;

svg_map["small_stripes"] = `<svg width="100" height="200">
<polygon points="5,0 20,0 20,200 5,200" stroke-width="4" fill="?" />
<polygon points="30,0 45,0 45,200 30,200" stroke-width="4" fill="?" />
<polygon points="55,0 70,0 70,200 55,200" stroke-width="4" fill="?" />
<polygon points="80,0 95,0 95,200 80,200" stroke-width="4" fill="?" />
</svg>`;

svg_map["stripe_downleft"] = `<svg width="100" height="200">
<polygon points="20,0 0,0 0,40 80,200 100,200 100,160" stroke-width="4" fill="?" />
</svg>`;

svg_map["stripe_downright"] = `<svg width="100" height="200">
<polygon points="80,0 100,0 100,40 20,200 0,200 0,160" stroke-width="4" fill="?" />
</svg>`;

svg_map["stripe_middle"] = `<svg width="100" height="200">
<polygon points="0,85 100,85 200,115 0,115" stroke-width="4" fill="?" />
</svg>`;

svg_map["straight_cross"] = `<svg width="100" height="200">
<polygon points="40,0 60,0 60,200 40,200" stroke-width="4" fill="?" />
<polygon points="0,90 100,90 100,110 0,110" stroke-width="4" fill="?" />
</svg>`;
